...
<body>
    ...
    <main>
        ...
        <div id="button_div">
            <button id="button_play" onclick="location.href='start.php'" accesskey="v"><h3>VOLVER A PROVAR</h3></button>
            <button id="button_play" onclick="location.href='start.php'" accesskey="n"><h3>SIGUIENTE NIVEL</h3></button>
        </div>
    </main>
    <footer>
