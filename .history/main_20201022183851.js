function Scroll(nombre) {
    this.id= nombre;
    this.avanza = avanza;
    this.anchoContenedor = document.getElementById(this.id).parentNode.offsetWidth;
    document.getElementById(this.id).parentNode.style.overflow="hidden";
    document.getElementById(this.id).parentNode.style.whiteSpace="nowrap";
    document.getElementById(this.id).parentNode.style.textIndent="0px";
    this.el=document.getElementById(this.id).parentNode;
    this.xo=this.el.getElementByTagName('span');
...
function avanza(velocidad,modo) {
   ...
   window.onload=function()
     {
       var scroll1= new Scroll('congrats');
